...
import { parseCourseTree, uploadBrainMaterial, generateFlashcards, generateQuizAction, evaluateQuizAction, generateSong } from "@/app/actions";
...
export default function CoursePage() {
    ...
    const [brainTab, setBrainTab] = useState<'content' | 'flashcards' | 'infographic' | 'videos' | 'extra' | 'quiz' | 'songs'>('content');
...
function SongsTab({ courseId }: { courseId: string }) {
    const supabase = createClient();
    const { playSound } = usePreferences();
        ...
        <div className="space-y-8">
            ...
            {songs.length === 0 && !isGenerating && (
                <div className="text-center py-12 text-foreground/40">
                    ...
                    <p>No songs generated yet. Create your first educational song above!</p>
                </div>
            )}
        </div>
    );
