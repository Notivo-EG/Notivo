    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 relative overflow-hidden selection:bg-sky-500/30">
            ...
            */}
            ...
            {/* Login Card Container with Perspective */}
            <div className="w-full max-w-md perspective-[2000px] relative z-10">
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Submit Button (Ethereal Glass) */}
                        <motion.button
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            type="submit"
                            onClick={() => playSound('click')}
                            className="relative group w-full py-4 rounded-full font-bold text-lg text-white overflow-hidden transition-all hover:brightness-125 hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] active:scale-95 border border-white/10 bg-gradient-to-r from-blue-500/80 via-indigo-500/80 to-purple-500/80 backdrop-blur-md"
                        >
                    ...
                    <p className="text-center mt-8 text-foreground/50">
                        ...
                        <Link href="/signup" onClick={() => playSound('click')} className="text-blue-500 hover:text-blue-400 font-medium transition-colors">
                            Sign up
                        </Link>
                    </p>
                </motion.div>
